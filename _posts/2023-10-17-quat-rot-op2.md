...
We often find ourselves _applying_ a sequence of rotations to the robot in many applications. To that end, it helps to know that the quaternions operators elegantly handle rotation sequences.
