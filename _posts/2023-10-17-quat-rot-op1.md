...
{% include figure.html path="assets/img/blog/pure_quat.png" class="img-fluid rounded img-width-25"  caption="Source: Jack B Kuipers. Quaternions and Rotation Sequences (1999)" zoomable=true %}
...
{% include figure.html path="assets/img/blog/quat_sandwich.png" class="img-fluid rounded img-width-25" caption="Source: Jack B Kuipers. Quaternions and Rotation Sequences (1999)" zoomable=true %}
...
{% include figure.html path="assets/img/blog/complex_plane.png" class="img-fluid rounded img-width-20" zoomable=true %}
...
{% include figure.html path="assets/img/blog/complex_product.png" class="img-fluid rounded img-width-20" caption="This is true if a3+ib3 = (a1+ib1)(a2+ib2)" zoomable=true %}
