...
> **:heavy_check_mark: Item 2 in the list is checked as long as $$R*{\mathbf{q}}$$ has sandwich product.**
...
> **:heavy_check_mark: Item 3 in the list is checked as long as the $$\mathbf{q}$$ in $$R*{\mathbf{q}}$$ is a unit quaternion.**
